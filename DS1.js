...
async function addPatient() {
  ...
  await fetch(" https://align-passport-lawyer-bathrooms.trycloudflare.com/add", {
    method: "POST",
...
async function loadPatients() {
  const res = await fetch(" https://align-passport-lawyer-bathrooms.trycloudflare.com/patients");
...
async function treatPriority() {
  const res = await fetch(" https://align-passport-lawyer-bathrooms.trycloudflare.com/priority");
  const data = await res.json();
