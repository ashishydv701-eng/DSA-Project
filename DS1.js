...
async function addPatient() {
  ...
  await fetch("https://ready-caution-naples-gras.trycloudflare.com/add", {
    method: "POST",
...
async function loadPatients() {
  const res = await fetch("https://ready-caution-naples-gras.trycloudflare.com/patients");
...
async function treatPriority() {
  const res = await fetch("https://ready-caution-naples-gras.trycloudflare.com/priority");
  const data = await res.json();
